...
public class Movie {
	...
	public Movie(int id, String title, String direction, String description, String genre, LocalDate date,
	...
	public void seTotalSeats(int totalSeats) {this.totalSeats = totalSeats;}
